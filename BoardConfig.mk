...
DEVICE_PATH := device/android/twgeneric
...
TW_SCREEN_BLANK_ON_BOOT := false # Changed to false so WebRTC doesn't start blacked out
TW_USE_TOOLBOX := true
TW_INCLUDE_REPACKTOOLS := true

# Cuttlefish WebRTC Input Fixes
TW_INPUT_BLACKLIST := "hwbinder"
TARGET_RECOVERY_DEVICE_MODULES += virtio-input
